...
analyze_log_file('access.log', command=1, num=5)
analyze_log_file('access.log', command=2, dT=60)
analyze_log_file('access.log', command=3, num=3)
analyze_log_file('access.log', command=4, dT=60)
analyze_log_file('access.log', command=5, num=3)
analyze_log_file('access.log', command=6, num=3, k=2)
analyze_log_file('access.log', command=7)
analyze_log_file('access.log', command=8, domains=['example.com', 'example.org'], sort_by='domain')
analyze_log_file('access.log', command=9, dT=30)
analyze_log_file('access.log', command=10, num=3, dT=2)
